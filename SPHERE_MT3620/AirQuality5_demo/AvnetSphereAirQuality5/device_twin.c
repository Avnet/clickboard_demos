...
twin_t twinArray[] = {
	...
	{.twinKey = "userR0_CO",.twinVar = &user_r0_co,.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_INT,.active_high = true},
	{.twinKey = "userR0_NO2",.twinVar = &user_r0_no2,.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_INT,.active_high = true},
	{.twinKey = "userR0_NH3",.twinVar = &user_r0_nh3,.twinFd = NULL,.twinGPIO = NO_GPIO_ASSOCIATED_WITH_TWIN,.twinType = TYPE_INT,.active_high = true}
};
